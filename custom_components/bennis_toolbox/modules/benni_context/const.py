"""Konstanten des Benni-Context-Moduls.

Die einzige HA-Domain ist `bennis_toolbox`. Storage-Keys, Service-Namen etc.
werden über die Toolbox-Helper aus dem `MODULE_ID` gebaut.
"""
...
MODULE_ID: Final = "benni_context"
NAME: Final = "Benni Context"
